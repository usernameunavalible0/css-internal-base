...
void CHelpers_DrawManager::Initialize()
{
	...
	I::Cvar->ConsoleColorPrintf({ 15, 150, 15, 255 }, "[CSS-Internal] CHelpers_DrawManager::Initialize() finished!\n");
}
...
void CHelpers_DrawManager::Uninitialize()
{
	...
	I::Cvar->ConsoleColorPrintf({ 15, 150, 15, 255 }, "[CSS-Internal] CHelpers_DrawManager::Uninitialize() finished!\n");
}
